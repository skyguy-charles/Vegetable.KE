...
class TestPlant:
    ...
    def test_plant_by_id_delete_route_deletes_plant(self):
        '''returns empty response at "/plants/<int:id>" after delete.'''
        with app.app_context():
            lo = Plant(
                name="Live Oak",
                image="https://www.nwf.org/-/media/NEW-WEBSITE/Shared-Folder/Wildlife/Plants-and-Fungi/plant_southern-live-oak_600x300.jpg",
                price=250.00,
                is_in_stock=False,
            )
